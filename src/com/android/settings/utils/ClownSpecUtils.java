...
public class ClownSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String CLOWN_CPU_MODEL_PROPERTY = "ro.clown.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelClown = SystemProperties.get(CLOWN_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelClown.isEmpty()) {
            return cpuModelClown;
